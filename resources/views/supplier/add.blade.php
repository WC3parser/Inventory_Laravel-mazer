                ...
                <div class="col-md-4 offser-md-4">
                    <form action="{{url('suppliers')}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" id="supplier" value="{{old('nama')}}" class="form-control @error('nama') is-invalid @enderror" autofocus>
                            @error('nama')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="no_telp" id="telp" value="{{old('no_telp')}}" class="form-control @error('no_telp') is-invalid @enderror">
                            @error('no_telp')
                            <div class="invalid-feedback">
                                {{$message}}
                            </div>
